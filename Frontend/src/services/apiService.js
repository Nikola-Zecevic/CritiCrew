...
// API configuration
const API_BASE_URL =
  import.meta.env.VITE_API_BASE_URL || "https://criticrew-1.onrender.com";
...
class ApiService {
  ...
  async getMoviesByGenre(genre, sort = "desc") {
    ...
    return await this.makeRequest(`/movies/?${params.toString()}`, {
      method: "GET",
    });
  }
  ...
  async getMovieReviews(movieId) {
    ...
    return await this.makeRequest(`/reviews/?movie_id=${movieId}`, {
      method: "GET",
    });
  }
  ...
  // Fetch movie data from OMDb API (external, not CritiCrew backend)
